#############################################################################
# Makefile for building: advisor
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  advisor.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile advisor.pro
#############################################################################
...
Makefile: advisor.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/advisor1.0.0 || mkdir -p .tmp/advisor1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/advisor1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/advisor1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/advisor1.0.0/ && (cd `dirname .tmp/advisor1.0.0` && $(TAR) advisor1.0.0.tar advisor1.0.0 && $(COMPRESS) advisor1.0.0.tar) && $(MOVE) `dirname .tmp/advisor1.0.0`/advisor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/advisor1.0.0
